...
%%% Tool names
\newcommand{\psqlsub}{\ensuremath{^{\mathsf{P}}}}
\newcommand{\msqlsub}{\ensuremath{^{\mathsf{M}}}}
...
We use the following abbreviations: \psqlsub{} = \ensuremath{\mathsf{PostgreSQL}}, \msqlsub{} = \ensuremath{\mathsf{MySQL}}, TO = Timeout of \togolf{}, RE = Runtime Error.}
\end{figure}
...
We use the following abbreviations: \psqlsub{} = \ensuremath{\mathsf{PostgreSQL}}, \msqlsub{} = \ensuremath{\mathsf{MySQL}}, GC = Gift Cards dataset, MI = Musical Instruments dataset, TO = Timeout of \tosusp{}.}
\label{fig:suspexps}
\end{figure}
\end{document}
